...
// RecalibrationInterval for roughtime and system time differences.
// Set as a default of once per hour.
const RecalibrationInterval = time.Hour

// offset is the difference between the system time and the time returned by the roughtime server
